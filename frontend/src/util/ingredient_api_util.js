...
export const getIngredientById = (id, amount = 1, unit = "gram") => {
  return axios.get(`https://api.spoonacular.com/food/ingredients/${id}/information?amount=${amount}&unit=${unit}&apiKey=${key.apiKey_spoon}`);
  // return axios({
  //   "method": "GET",
...
export const getIngredientSubstitutes = (ingredientName) => {
  return axios.get(`https: //api.spoonacular.com/food/ingredients/substitutes?ingredientName=${ingredientName}&apiKey=${key.apiKey_spoon}`);
  // return axios({
  //   "method": "GET",
...
export const getConvertAmounts = (ingredient, sourceUnit, sourceAmount, targetUnit="grams") => {
  ...
  return axios({
    ...
    "headers": {
      "content-type": "application/octet-stream",
      "x-rapidapi-host": "spoonacular-recipe-food-nutrition-v1.p.rapidapi.com",
      "x-rapidapi-key": key.apiKey_spoon
    }, "params": {
